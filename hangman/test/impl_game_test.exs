defmodule HangmanImplGameTest do
  ...
  test "can handle a failing game" do
    [
      ...
      ["o",     :good_guess,    5,    ["_","e","l","l","o",], ["a", "e", "l", "o", "x"] ],
      ["y",     :bad_guess,     4,    ["_","e","l","l","o",], ["a", "e", "l", "o", "x", "y"] ],
      ["i",     :bad_guess,     3,    ["_","e","l","l","o",], ["a", "e", "i", "l", "o", "x","y"] ],
      ["j",     :bad_guess,     2,    ["_","e","l","l","o",], ["a", "e", "i", "j", "l", "o", "x","y"] ],
      ["k",     :bad_guess,     1,    ["_","e","l","l","o",], ["a", "e", "i", "j", "k", "l", "o", "x","y"] ],
      ["m",     :lost,          0,    ["_","e","l","l","o",], ["a", "e", "i", "j", "k", "l", "m", "o", "x","y"] ],
    ]
    |> test_sequence_of_moves()
  end

  test "uppercase letters become lower" do
    game = Game.new_game("ace")
    {game, _tally} = Game.make_move(game, "A")
    assert MapSet.equal?(game.used, MapSet.new(["a"]))
  end
